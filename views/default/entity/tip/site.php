...
<table class="elgg-table" style="width: auto !important;">
	...
	<tbody>
		<tr>
			<td><?php echo elgg_echo('entity_browser:table:header:subtype'); ?></td>
			<td><?php echo $entity->getSubtype(); ?></td>
		</tr>
		<tr>
			<td><?php echo elgg_echo('entity_browser:table:header:subtype'); ?></td>
			<td><?php echo elgg_echo('subtype'); ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td><?php echo elgg_echo('entity_browser:table:header:url'); ?></td>
			<td><a href="<?php echo $entity->url; ?>" target="_blank"><?php echo $entity->url; ?></a></td>
		</tr>
		<tr>
