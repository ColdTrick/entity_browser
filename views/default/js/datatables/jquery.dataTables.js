...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnAjaxParameters( oSettings )
		{
			...
			//'&__elgg_ts='+elgg.security.addToken().__elgg_token+'&__elgg_token='+elgg.security.addToken().__elgg_token

			aoData.push( {"name": "__elgg_ts", "value": elgg.security.addToken().__elgg_ts} );
			aoData.push( {"name": "__elgg_token", "value": elgg.security.addToken().__elgg_token} );
